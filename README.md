...
# Yield Prediction: 
Estimates the expected crop yield using agricultural input features.
Supports better planning for harvesting, storage, and market decisions.

# Weather Prediction:
Predicts weather-related farming conditions.
Divided into:
Temperature Prediction
Rainfall Prediction

# Irrigation Prediction:
Predicts the irrigation requirement based on soil moisture, weather, and crop needs.
Helps avoid overwatering and underwatering.
